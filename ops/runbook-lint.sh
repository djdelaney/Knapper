...
KNOWN='lan-resolver|backup-storage|parent-dataset|rootfs-dataset|archive|fresh-archive|storage|nn|PINNED|v|token|secret|monitor-token|monitor-secret|smoke-hostname|smoke-access-app-aud|ct-address|term|ref|vmid|scratch-vmid|https://YOURTEAM.cloudflareaccess.com|EDITOR'
